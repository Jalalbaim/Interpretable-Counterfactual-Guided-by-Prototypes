...
def train_epochs(model, trainloader, testloader, criterion, optimizer, device, num_epochs, save_interval=5):
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % save_interval == 0:
          ...
          torch.save(checkpoint, f'./Counterfactual implementation/weights/resnet50_cifar10_variables_{epoch+1}.pth')
...
def plot_image(dataset, model, classes, device=None):
...
if __name__ == '__main__':
    ...
    if train_model:
      ...
      torch.save(model.state_dict(), f'./Counterfactual implementation/weights/resnet50_cifar10_final_model_epochs_{num_epochs}.pth')
